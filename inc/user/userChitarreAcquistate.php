...
<div id = "listaInserzioni">
	...
	<?php if($items == NULL) echo '<p class = "errorMessage">Non hai acquistato nessuno strumento </p>';
		  else echo " <h3> Lista acquisti di $user </h3> ";
	?>
	<hr/><br/>
	...
	<div class = "inserzione">
		...
		<div class = "utente">
			<p class = "nomeUtente"> Venditore: <?php echo $insertore ?> </p>
